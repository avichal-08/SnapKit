...
export default function Home(){
    ...
    return(
        <div className="flex flex-wrap gap-3 pt-10">
            ...
            <button className="bg-blue-500 text-white w-[48%] py-2 rounded-lg font-semibold hover:bg-blue-600 transition duration-200 cursor-pointer" onClick={()=>navigate('/format')}>Format Converter</button>
            <button className="bg-blue-500 text-white w-[48%] py-2 rounded-lg font-semibold hover:bg-blue-600 transition duration-200 cursor-pointer" onClick={()=>navigate('/objremove')}>Object Remover</button>
        </div>
    )
}